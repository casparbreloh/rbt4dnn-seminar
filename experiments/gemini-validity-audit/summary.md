...
OpenRouter judges whether generated images visibly satisfy the natural-language requirement with Gemini Flash. This is an external audit, not ground truth.
If quota stops a run, rerun the same command later; cached rows are skipped.

Completed-sample valid rate: 0.738.
